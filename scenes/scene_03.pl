...
action(6, bar, yellow, 'North-South', [-6,-6,0], 5).
action(7, brick, yellow, 'North-South', [-6,-4,1], 5).
action(8, cube, yellow, 'North-South', [-6,-2,2], 5).

action(10, cube, red, 'East-West', [2,-6,0], 9).
action(11, cube, red, 'East-West', [2,-6,1], 9).
action(12, cube, red, 'East-West', [2,-6,2], 9).
