...
num_of_agents(1).
agent(fred, [0,-15,15]).
reachable_actions(fred, [2,3,4,6,7,8,10]).
...
all_applied_actions([]).
all_completed_tasks([]).
pending_actions([2,3,4,6,7,8,10]).
...
action(2, bar, red, 'East-West', [0,0,0], 1).
action(3, brick, red, 'East-West', [0,0,1], 1).
action(4, cube, red, 'East-West', [0,0,2], 1).

action(6, bar, red, 'East-West', [-8,0,0], 5).
action(7, brick, red, 'East-West', [-6,0,1], 5).
action(8, cube, red, 'East-West', [-4,0,2], 5).

action(10, bar, yellow, 'East-West', [-4,0,3], 9).

construction(staircase_bridge).
task(1, staircase, 'size', neutral).
task(5, staircase, 'size', neutral).
